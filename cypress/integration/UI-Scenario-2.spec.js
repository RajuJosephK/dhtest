...
describe('UI Scenario 2', () => {
	...
	it('Test to verify buy product workflow', () => {
		...
		cy.get('.snip-product__remove').then(($el) => expect($el).to.have.css('color', 'rgb(255, 17, 0)'));
		...
		cy.get('#snipcart-guest-checkout').then(($el) => expect($el).to.have.css('color', 'rgb(34, 34, 34)'));
